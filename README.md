...
|---|---|---|
| **Code Efficiency & Architecture** | [`ponytail`](./alfazen-coding/ponytail), [`alfazen-versioning`](./alfazen-coding/alfazen-versioning), [`handoff`](./alfazen-coding/handoff) | Anti-bloat Decision Ladder, Git patch bumps, and project checkpoints |
...
| Skill | Description |
|---|---|
| [`alfazen-versioning`](./alfazen-coding/alfazen-versioning) | Bounded `m.n.p` Git versioning with per-commit patch bumps and UTC build IDs |
...
- **Alfazen Inc.**:
  - `alfazen-versioning` — Bounded `m.n.p` Git versioning with per-commit patch bumps and UTC build IDs.
